...
def index():
    if request.method == 'POST':
        ...
        API_KEY = "M_XoCZ2h_a5r9RPUlUKG5-OV0CTBpdQMlvm-At-0LigB"
        ...
        response_scoring = requests.post(
            'https://us-south.ml.cloud.ibm.com/ml/v4/deployments/897e2130-9c68-4f22-990b-74c2432e530d/predictions?version=2022-11-19', 
